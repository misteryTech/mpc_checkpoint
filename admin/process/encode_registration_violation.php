...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt->bind_param("sssssssss", $officer_name, $violation_type, $vehicle_plate_number, $driver_name,
                      $violation_location, $violation_date, $violation_time, $evidence_path, $additional_notes);
