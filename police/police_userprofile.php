...
<body>
     ...
     <!-- ======= Sidebar ======= -->
<?php
    include("police_topnav.php");
    include("police_sidenav.php");


    $Fullname  = $_SESSION['police_firstname']. ' '. $_SESSION['police_lastname'];
    $role = $_SESSION['rank'];
    $username = $_SESSION['username'];
    $firstname = $_SESSION['police_firstname'];
    $lastname = $_SESSION['police_lastname'];
?>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="company" type="text" class="form-control" id="company" value="<?php echo htmlspecialchars($role); ?>">
                      </div>
                    </div>
