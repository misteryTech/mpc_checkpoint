  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        <li class="dropdown-header">
          <h6><?php echo htmlspecialchars($_SESSION['police_firstname']). ' ' . htmlspecialchars($_SESSION['police_lastname']); ?></h6>
          <span><?php echo htmlspecialchars($_SESSION['rank']) ?></span>
        </li>
        <li>
          <hr class="dropdown-divider">
        </li>
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="police_userprofile.php">
